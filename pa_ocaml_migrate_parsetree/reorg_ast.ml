...
and 'a location_loc = [%import: 'a All_ast.Ast_5_3.Location.loc
    [@with t := location_t]
]
and longident_t = [%import: All_ast.Ast_5_3.Longident.t
    [@with t := longident_t]
]

and label = [%import: All_ast.Ast_5_3.Asttypes.label]
and arg_label = [%import: All_ast.Ast_5_3.Asttypes.arg_label]

and closed_flag =  [%import: All_ast.Ast_5_3.Asttypes.closed_flag]
and rec_flag =  [%import: All_ast.Ast_5_3.Asttypes.rec_flag]
and direction_flag =  [%import: All_ast.Ast_5_3.Asttypes.direction_flag]
and private_flag =  [%import: All_ast.Ast_5_3.Asttypes.private_flag]
and mutable_flag =  [%import: All_ast.Ast_5_3.Asttypes.mutable_flag]
and virtual_flag =  [%import: All_ast.Ast_5_3.Asttypes.virtual_flag]
and override_flag =  [%import: All_ast.Ast_5_3.Asttypes.override_flag]
and variance =  [%import: All_ast.Ast_5_3.Asttypes.variance]
and injectivity =  [%import: All_ast.Ast_5_3.Asttypes.injectivity]
and constant =  [%import: All_ast.Ast_5_3.Parsetree.constant
    [@with Location.t := location_t]
]
and constant_desc =  [%import: All_ast.Ast_5_3.Parsetree.constant_desc
    [@with Location.t := location_t]
]
and location_stack = [%import: All_ast.Ast_5_3.Parsetree.location_stack
    [@with Location.t := location_t]
]
and attribute = [%import: All_ast.Ast_5_3.Parsetree.attribute
    [@with Asttypes.loc := location_loc
         ; Location.t := location_t
    ]
]
and extension = [%import: All_ast.Ast_5_3.Parsetree.extension
    [@with Asttypes.loc := location_loc]
]
and attributes = [%import: All_ast.Ast_5_3.Parsetree.attributes]
and payload = [%import: All_ast.Ast_5_3.Parsetree.payload]
and core_type = [%import: All_ast.Ast_5_3.Parsetree.core_type
    [@with Location.t := location_t]
]
and core_type_desc = [%import: All_ast.Ast_5_3.Parsetree.core_type_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.closed_flag := closed_flag
         ; Asttypes.arg_label := arg_label
...
and package_type = [%import: All_ast.Ast_5_3.Parsetree.package_type
    [@with Longident.t := longident_t
          ; Asttypes.loc := location_loc
    ]
]
and row_field = [%import: All_ast.Ast_5_3.Parsetree.row_field
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ; Location.t := location_t
...
and row_field_desc = [%import: All_ast.Ast_5_3.Parsetree.row_field_desc
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ]
]
and object_field = [%import: All_ast.Ast_5_3.Parsetree.object_field
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ; Location.t := location_t
...
and object_field_desc = [%import: All_ast.Ast_5_3.Parsetree.object_field_desc
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ]
]
and pattern = [%import: All_ast.Ast_5_3.Parsetree.pattern
    [@with Location.t := location_t]
]
and pattern_desc = [%import: All_ast.Ast_5_3.Parsetree.pattern_desc
    [@with Longident.t := longident_t ;
      Asttypes.loc := location_loc ;
      Asttypes.label := label ;
      Asttypes.closed_flag := closed_flag
...
and expression = [%import: All_ast.Ast_5_3.Parsetree.expression
    [@with Location.t := location_t]
]
and expression_desc = [%import: All_ast.Ast_5_3.Parsetree.expression_desc
    [@with Longident.t := longident_t ;
      Asttypes.loc := location_loc ;
      Asttypes.label := label ;
      Asttypes.arg_label := arg_label ;
...
and case = [%import: All_ast.Ast_5_3.Parsetree.case]
and letop = [%import: All_ast.Ast_5_3.Parsetree.letop]
and binding_op = [%import: All_ast.Ast_5_3.Parsetree.binding_op
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and function_param_desc = [%import: All_ast.Ast_5_3.Parsetree.function_param_desc [@with Asttypes.loc := location_loc ; Asttypes.label := label ; Asttypes.arg_label := arg_label ; Asttypes.closed_flag := closed_flag ; Asttypes.rec_flag := rec_flag ; Asttypes.direction_flag := direction_flag ; Asttypes.private_flag := private_flag ; Asttypes.mutable_flag := mutable_flag ; Asttypes.virtual_flag := virtual_flag ; Asttypes.variance := variance ; Asttypes.override_flag := override_flag ; Asttypes.variance := variance ; Asttypes.injectivity := injectivity]]
and function_param = [%import: All_ast.Ast_5_3.Parsetree.function_param
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and function_body = [%import: All_ast.Ast_5_3.Parsetree.function_body
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_constraint = [%import: All_ast.Ast_5_3.Parsetree.type_constraint]
and value_description = [%import: All_ast.Ast_5_3.Parsetree.value_description
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_declaration = [%import: All_ast.Ast_5_3.Parsetree.type_declaration
    [@with Location.t := location_t
          ; Asttypes.loc := location_loc
          ; Asttypes.variance := variance
          ; Asttypes.injectivity := injectivity
...
and type_kind = [%import: All_ast.Ast_5_3.Parsetree.type_kind]
and label_declaration = [%import: All_ast.Ast_5_3.Parsetree.label_declaration
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.mutable_flag := mutable_flag
    ]
]
and constructor_declaration = [%import: All_ast.Ast_5_3.Parsetree.constructor_declaration
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and constructor_arguments = [%import: All_ast.Ast_5_3.Parsetree.constructor_arguments]
and type_extension = [%import: All_ast.Ast_5_3.Parsetree.type_extension
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.variance := variance
         ; Asttypes.injectivity := injectivity
...
and extension_constructor = [%import: All_ast.Ast_5_3.Parsetree.extension_constructor
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_exception = [%import: All_ast.Ast_5_3.Parsetree.type_exception
    [@with Location.t := location_t ;]
]
and extension_constructor_kind = [%import: All_ast.Ast_5_3.Parsetree.extension_constructor_kind
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and class_type = [%import: All_ast.Ast_5_3.Parsetree.class_type
    [@with Location.t := location_t]
]
and class_type_desc = [%import: All_ast.Ast_5_3.Parsetree.class_type_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.label := label
         ; Asttypes.arg_label := arg_label
...
and class_signature = [%import: All_ast.Ast_5_3.Parsetree.class_signature]
and class_type_field = [%import: All_ast.Ast_5_3.Parsetree.class_type_field
    [@with Location.t := location_t]
]
and class_type_field_desc = [%import: All_ast.Ast_5_3.Parsetree.class_type_field_desc
    [@with
      Asttypes.private_flag := private_flag
    ; Asttypes.mutable_flag := mutable_flag
    ; Asttypes.virtual_flag := virtual_flag
...
and 'a class_infos = [%import: 'a All_ast.Ast_5_3.Parsetree.class_infos
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.variance := variance
         ; Asttypes.injectivity := injectivity
...
and class_description = [%import: All_ast.Ast_5_3.Parsetree.class_description]
and class_type_declaration = [%import: All_ast.Ast_5_3.Parsetree.class_type_declaration]
and class_expr = [%import: All_ast.Ast_5_3.Parsetree.class_expr
    [@with Location.t := location_t]
]
and class_expr_desc = [%import: All_ast.Ast_5_3.Parsetree.class_expr_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.rec_flag := rec_flag
         ; Asttypes.label := label
...
and class_structure = [%import: All_ast.Ast_5_3.Parsetree.class_structure]
and class_field = [%import: All_ast.Ast_5_3.Parsetree.class_field
    [@with Location.t := location_t]
]
and class_field_desc = [%import: All_ast.Ast_5_3.Parsetree.class_field_desc
    [@with Asttypes.loc := location_loc
         ; Asttypes.override_flag := override_flag
         ; Asttypes.mutable_flag := mutable_flag
         ; Asttypes.private_flag := private_flag
...
and class_field_kind = [%import: All_ast.Ast_5_3.Parsetree.class_field_kind
    [@with Asttypes.override_flag := override_flag
    ]
]
and class_declaration = [%import: All_ast.Ast_5_3.Parsetree.class_declaration]
and module_type = [%import: All_ast.Ast_5_3.Parsetree.module_type
    [@with Location.t := location_t]
]
and module_type_desc = [%import: All_ast.Ast_5_3.Parsetree.module_type_desc
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and functor_parameter = [%import: All_ast.Ast_5_3.Parsetree.functor_parameter
    [@with Asttypes.loc := location_loc]
]
and signature = [%import: All_ast.Ast_5_3.Parsetree.signature]
and signature_item = [%import: All_ast.Ast_5_3.Parsetree.signature_item
    [@with Location.t := location_t]
]
and signature_item_desc = [%import: All_ast.Ast_5_3.Parsetree.signature_item_desc
    [@with Asttypes.rec_flag := rec_flag]
]
and module_declaration = [%import: All_ast.Ast_5_3.Parsetree.module_declaration
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and module_substitution = [%import: All_ast.Ast_5_3.Parsetree.module_substitution
    [@with Longident.t := longident_t
         ; Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and module_type_declaration = [%import: All_ast.Ast_5_3.Parsetree.module_type_declaration
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and 'a open_infos = [%import: 'a All_ast.Ast_5_3.Parsetree.open_infos
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.override_flag := override_flag
    ]
]
and open_description = [%import: All_ast.Ast_5_3.Parsetree.open_description
    [@with Longident.t := longident_t
          ; Asttypes.loc := location_loc
    ]
]
and open_declaration = [%import: All_ast.Ast_5_3.Parsetree.open_declaration]
and 'a include_infos = [%import: 'a All_ast.Ast_5_3.Parsetree.include_infos
    [@with Location.t := location_t]
]
and include_description = [%import: All_ast.Ast_5_3.Parsetree.include_description]
and include_declaration = [%import: All_ast.Ast_5_3.Parsetree.include_declaration]
and with_constraint = [%import: All_ast.Ast_5_3.Parsetree.with_constraint
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
    ]
]
and module_expr = [%import: All_ast.Ast_5_3.Parsetree.module_expr
    [@with Location.t := location_t]
]
and module_expr_desc = [%import: All_ast.Ast_5_3.Parsetree.module_expr_desc
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and structure = [%import: All_ast.Ast_5_3.Parsetree.structure]
and structure_item = [%import: All_ast.Ast_5_3.Parsetree.structure_item
    [@with Location.t := location_t]
]
and structure_item_desc = [%import: All_ast.Ast_5_3.Parsetree.structure_item_desc
    [@with Location.t := location_t
          ; Longident.t := longident_t
          ; Asttypes.loc := location_loc
          ; Asttypes.rec_flag := rec_flag
...
and value_binding = [%import: All_ast.Ast_5_3.Parsetree.value_binding
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and value_constraint = [%import: All_ast.Ast_5_3.Parsetree.value_constraint
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and module_binding = [%import: All_ast.Ast_5_3.Parsetree.module_binding
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and type_immediacy_t = [%import: All_ast.Ast_5_3.Type_immediacy.t]
and out_name = [%import: All_ast.Ast_5_3.Outcometree.out_name]
...
and out_variant = [%import: All_ast.Ast_5_3.Outcometree.out_variant]
and out_class_type = [%import: All_ast.Ast_5_3.Outcometree.out_class_type
    [@with Asttypes.arg_label := arg_label]
]
and out_class_sig_item = [%import: All_ast.Ast_5_3.Outcometree.out_class_sig_item]
and out_module_type = [%import: All_ast.Ast_5_3.Outcometree.out_module_type]
and out_sig_item = [%import: All_ast.Ast_5_3.Outcometree.out_sig_item]
and out_type_param = [%import: All_ast.Ast_5_3.Outcometree.out_type_param
    [@with
       Asttypes.variance := variance
     ; Asttypes.injectivity := injectivity
    ]
]
and out_type_decl = [%import: All_ast.Ast_5_3.Outcometree.out_type_decl
    [@with Asttypes.private_flag := private_flag
        ; Type_immediacy.t := type_immediacy_t
    ]
]
and out_extension_constructor = [%import: All_ast.Ast_5_3.Outcometree.out_extension_constructor
    [@with Asttypes.private_flag := private_flag]
]
and out_constructor = [%import: All_ast.Ast_5_3.Outcometree.out_constructor]
and out_type_extension = [%import: All_ast.Ast_5_3.Outcometree.out_type_extension
    [@with Asttypes.private_flag := private_flag]
]
and out_val_decl = [%import: All_ast.Ast_5_3.Outcometree.out_val_decl]
...
module Ast_5_4 = struct
module Format_doc = All_ast.Ast_5_4.Format_doc
type lexing_position = [%import: All_ast.Ast_5_4.Lexing.position]
and location_t = [%import: All_ast.Ast_5_4.Location.t
    [@with Lexing.position := lexing_position]
]
and 'a location_loc = [%import: 'a All_ast.Ast_5_4.Location.loc
    [@with t := location_t]
]
...
and arg_label = [%import: All_ast.Ast_5_4.Asttypes.arg_label]

and atomic_flag =  [%import: All_ast.Ast_5_4.Asttypes.atomic_flag]
and closed_flag =  [%import: All_ast.Ast_5_4.Asttypes.closed_flag]
and rec_flag =  [%import: All_ast.Ast_5_4.Asttypes.rec_flag]
and direction_flag =  [%import: All_ast.Ast_5_4.Asttypes.direction_flag]
and private_flag =  [%import: All_ast.Ast_5_4.Asttypes.private_flag]
and mutable_flag =  [%import: All_ast.Ast_5_4.Asttypes.mutable_flag]
and virtual_flag =  [%import: All_ast.Ast_5_4.Asttypes.virtual_flag]
and override_flag =  [%import: All_ast.Ast_5_4.Asttypes.override_flag]
and variance =  [%import: All_ast.Ast_5_4.Asttypes.variance]
and injectivity =  [%import: All_ast.Ast_5_4.Asttypes.injectivity]

and constant =  [%import: All_ast.Ast_5_4.Parsetree.constant
    [@with Location.t := location_t]
]
and constant_desc =  [%import: All_ast.Ast_5_4.Parsetree.constant_desc
    [@with Location.t := location_t]
]
and location_stack = [%import: All_ast.Ast_5_4.Parsetree.location_stack
    [@with Location.t := location_t]
]
and attribute = [%import: All_ast.Ast_5_4.Parsetree.attribute
    [@with Asttypes.loc := location_loc
         ; Location.t := location_t
    ]
]
and extension = [%import: All_ast.Ast_5_4.Parsetree.extension
    [@with Asttypes.loc := location_loc]
]
and attributes = [%import: All_ast.Ast_5_4.Parsetree.attributes]
and payload = [%import: All_ast.Ast_5_4.Parsetree.payload]
and core_type = [%import: All_ast.Ast_5_4.Parsetree.core_type
    [@with Location.t := location_t]
]
and core_type_desc = [%import: All_ast.Ast_5_4.Parsetree.core_type_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.closed_flag := closed_flag
         ; Asttypes.arg_label := arg_label
...
and package_type = [%import: All_ast.Ast_5_4.Parsetree.package_type
    [@with Longident.t := longident_t
          ; Asttypes.loc := location_loc
          ; Location.t := location_t
    ]
]
and row_field = [%import: All_ast.Ast_5_4.Parsetree.row_field
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ; Location.t := location_t
...
and row_field_desc = [%import: All_ast.Ast_5_4.Parsetree.row_field_desc
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ]
]
and object_field = [%import: All_ast.Ast_5_4.Parsetree.object_field
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ; Location.t := location_t
...
and object_field_desc = [%import: All_ast.Ast_5_4.Parsetree.object_field_desc
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ]
]
and pattern = [%import: All_ast.Ast_5_4.Parsetree.pattern
    [@with Location.t := location_t]
]
and pattern_desc = [%import: All_ast.Ast_5_4.Parsetree.pattern_desc
    [@with Longident.t := longident_t ;
      Asttypes.loc := location_loc ;
      Asttypes.label := label ;
      Asttypes.closed_flag := closed_flag
...
and expression = [%import: All_ast.Ast_5_4.Parsetree.expression
    [@with Location.t := location_t]
]
and expression_desc = [%import: All_ast.Ast_5_4.Parsetree.expression_desc
    [@with Longident.t := longident_t ;
      Asttypes.loc := location_loc ;
      Asttypes.label := label ;
      Asttypes.arg_label := arg_label ;
...
and case = [%import: All_ast.Ast_5_4.Parsetree.case]
and letop = [%import: All_ast.Ast_5_4.Parsetree.letop]
and binding_op = [%import: All_ast.Ast_5_4.Parsetree.binding_op
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and function_param_desc = [%import: All_ast.Ast_5_4.Parsetree.function_param_desc [@with Asttypes.loc := location_loc ; Asttypes.label := label ; Asttypes.arg_label := arg_label ; Asttypes.closed_flag := closed_flag ; Asttypes.rec_flag := rec_flag ; Asttypes.direction_flag := direction_flag ; Asttypes.private_flag := private_flag ; Asttypes.mutable_flag := mutable_flag ; Asttypes.virtual_flag := virtual_flag ; Asttypes.variance := variance ; Asttypes.override_flag := override_flag ; Asttypes.variance := variance ; Asttypes.injectivity := injectivity]]
and function_param = [%import: All_ast.Ast_5_4.Parsetree.function_param
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and function_body = [%import: All_ast.Ast_5_4.Parsetree.function_body
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_constraint = [%import: All_ast.Ast_5_4.Parsetree.type_constraint]
and value_description = [%import: All_ast.Ast_5_4.Parsetree.value_description
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_declaration = [%import: All_ast.Ast_5_4.Parsetree.type_declaration
    [@with Location.t := location_t
          ; Asttypes.loc := location_loc
          ; Asttypes.variance := variance
          ; Asttypes.injectivity := injectivity
...
and type_kind = [%import: All_ast.Ast_5_4.Parsetree.type_kind]
and label_declaration = [%import: All_ast.Ast_5_4.Parsetree.label_declaration
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.mutable_flag := mutable_flag
    ]
]
and constructor_declaration = [%import: All_ast.Ast_5_4.Parsetree.constructor_declaration
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and constructor_arguments = [%import: All_ast.Ast_5_4.Parsetree.constructor_arguments]
and type_extension = [%import: All_ast.Ast_5_4.Parsetree.type_extension
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.variance := variance
         ; Asttypes.injectivity := injectivity
...
and extension_constructor = [%import: All_ast.Ast_5_4.Parsetree.extension_constructor
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_exception = [%import: All_ast.Ast_5_4.Parsetree.type_exception
    [@with Location.t := location_t ;]
]
and extension_constructor_kind = [%import: All_ast.Ast_5_4.Parsetree.extension_constructor_kind
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and class_type = [%import: All_ast.Ast_5_4.Parsetree.class_type
    [@with Location.t := location_t]
]
and class_type_desc = [%import: All_ast.Ast_5_4.Parsetree.class_type_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.label := label
         ; Asttypes.arg_label := arg_label
...
and class_signature = [%import: All_ast.Ast_5_4.Parsetree.class_signature]
and class_type_field = [%import: All_ast.Ast_5_4.Parsetree.class_type_field
    [@with Location.t := location_t]
]
and class_type_field_desc = [%import: All_ast.Ast_5_4.Parsetree.class_type_field_desc
    [@with
      Asttypes.private_flag := private_flag
    ; Asttypes.mutable_flag := mutable_flag
    ; Asttypes.virtual_flag := virtual_flag
...
and 'a class_infos = [%import: 'a All_ast.Ast_5_4.Parsetree.class_infos
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.variance := variance
         ; Asttypes.injectivity := injectivity
...
and class_description = [%import: All_ast.Ast_5_4.Parsetree.class_description]
and class_type_declaration = [%import: All_ast.Ast_5_4.Parsetree.class_type_declaration]
and class_expr = [%import: All_ast.Ast_5_4.Parsetree.class_expr
    [@with Location.t := location_t]
]
and class_expr_desc = [%import: All_ast.Ast_5_4.Parsetree.class_expr_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.rec_flag := rec_flag
         ; Asttypes.label := label
...
and class_structure = [%import: All_ast.Ast_5_4.Parsetree.class_structure]
and class_field = [%import: All_ast.Ast_5_4.Parsetree.class_field
    [@with Location.t := location_t]
]
and class_field_desc = [%import: All_ast.Ast_5_4.Parsetree.class_field_desc
    [@with Asttypes.loc := location_loc
         ; Asttypes.override_flag := override_flag
         ; Asttypes.mutable_flag := mutable_flag
         ; Asttypes.private_flag := private_flag
...
and class_field_kind = [%import: All_ast.Ast_5_4.Parsetree.class_field_kind
    [@with Asttypes.override_flag := override_flag
    ]
]
and class_declaration = [%import: All_ast.Ast_5_4.Parsetree.class_declaration]
and module_type = [%import: All_ast.Ast_5_4.Parsetree.module_type
    [@with Location.t := location_t]
]
and module_type_desc = [%import: All_ast.Ast_5_4.Parsetree.module_type_desc
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and functor_parameter = [%import: All_ast.Ast_5_4.Parsetree.functor_parameter
    [@with Asttypes.loc := location_loc]
]
and signature = [%import: All_ast.Ast_5_4.Parsetree.signature]
and signature_item = [%import: All_ast.Ast_5_4.Parsetree.signature_item
    [@with Location.t := location_t]
]
and signature_item_desc = [%import: All_ast.Ast_5_4.Parsetree.signature_item_desc
    [@with Asttypes.rec_flag := rec_flag]
]
and module_declaration = [%import: All_ast.Ast_5_4.Parsetree.module_declaration
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and module_substitution = [%import: All_ast.Ast_5_4.Parsetree.module_substitution
    [@with Longident.t := longident_t
         ; Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and module_type_declaration = [%import: All_ast.Ast_5_4.Parsetree.module_type_declaration
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and 'a open_infos = [%import: 'a All_ast.Ast_5_4.Parsetree.open_infos
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.override_flag := override_flag
    ]
]
and open_description = [%import: All_ast.Ast_5_4.Parsetree.open_description
    [@with Longident.t := longident_t
          ; Asttypes.loc := location_loc
    ]
]
and open_declaration = [%import: All_ast.Ast_5_4.Parsetree.open_declaration]
and 'a include_infos = [%import: 'a All_ast.Ast_5_4.Parsetree.include_infos
    [@with Location.t := location_t]
]
and include_description = [%import: All_ast.Ast_5_4.Parsetree.include_description]
and include_declaration = [%import: All_ast.Ast_5_4.Parsetree.include_declaration]
and with_constraint = [%import: All_ast.Ast_5_4.Parsetree.with_constraint
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
    ]
]
and module_expr = [%import: All_ast.Ast_5_4.Parsetree.module_expr
    [@with Location.t := location_t]
]
and module_expr_desc = [%import: All_ast.Ast_5_4.Parsetree.module_expr_desc
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and structure = [%import: All_ast.Ast_5_4.Parsetree.structure]
and structure_item = [%import: All_ast.Ast_5_4.Parsetree.structure_item
    [@with Location.t := location_t]
]
and structure_item_desc = [%import: All_ast.Ast_5_4.Parsetree.structure_item_desc
    [@with Location.t := location_t
          ; Longident.t := longident_t
          ; Asttypes.loc := location_loc
          ; Asttypes.rec_flag := rec_flag
...
and value_binding = [%import: All_ast.Ast_5_4.Parsetree.value_binding
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and value_constraint = [%import: All_ast.Ast_5_4.Parsetree.value_constraint
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and module_binding = [%import: All_ast.Ast_5_4.Parsetree.module_binding
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and type_immediacy_t = [%import: All_ast.Ast_5_4.Type_immediacy.t]
and out_name = [%import: All_ast.Ast_5_4.Outcometree.out_name]
and out_ident = [%import: All_ast.Ast_5_4.Outcometree.out_ident]
...
and out_variant = [%import: All_ast.Ast_5_4.Outcometree.out_variant]
and out_class_type = [%import: All_ast.Ast_5_4.Outcometree.out_class_type
    [@with Asttypes.arg_label := arg_label]
]
and out_class_sig_item = [%import: All_ast.Ast_5_4.Outcometree.out_class_sig_item]
and out_module_type = [%import: All_ast.Ast_5_4.Outcometree.out_module_type]
and out_sig_item = [%import: All_ast.Ast_5_4.Outcometree.out_sig_item]
and out_type_param = [%import: All_ast.Ast_5_4.Outcometree.out_type_param
    [@with
       Asttypes.variance := variance
     ; Asttypes.injectivity := injectivity
    ]
]
and out_type_decl = [%import: All_ast.Ast_5_4.Outcometree.out_type_decl
    [@with Asttypes.private_flag := private_flag
        ; Type_immediacy.t := type_immediacy_t
    ]
]
and out_extension_constructor = [%import: All_ast.Ast_5_4.Outcometree.out_extension_constructor
    [@with Asttypes.private_flag := private_flag]
]
and out_constructor = [%import: All_ast.Ast_5_4.Outcometree.out_constructor]
and out_type_extension = [%import: All_ast.Ast_5_4.Outcometree.out_type_extension
    [@with Asttypes.private_flag := private_flag]
]
and out_val_decl = [%import: All_ast.Ast_5_4.Outcometree.out_val_decl]
and out_rec_status = [%import: All_ast.Ast_5_4.Outcometree.out_rec_status]
and out_ext_status = [%import: All_ast.Ast_5_4.Outcometree.out_ext_status]
and out_phrase = [%import: All_ast.Ast_5_4.Outcometree.out_phrase]
...
module Ast_5_5 = struct
module Format_doc = All_ast.Ast_5_5.Format_doc
type lexing_position = [%import: All_ast.Ast_5_5.Lexing.position]
and location_t = [%import: All_ast.Ast_5_5.Location.t
    [@with Lexing.position := lexing_position]
]
and 'a location_loc = [%import: 'a All_ast.Ast_5_5.Location.loc
    [@with t := location_t]
]
and longident_t = [%import: All_ast.Ast_5_5.Longident.t
    [@with t := longident_t
         ; Location.loc := location_loc
    ]
]

and label = [%import: All_ast.Ast_5_5.Asttypes.label]
and arg_label = [%import: All_ast.Ast_5_5.Asttypes.arg_label]

and atomic_flag =  [%import: All_ast.Ast_5_5.Asttypes.atomic_flag]
and closed_flag =  [%import: All_ast.Ast_5_5.Asttypes.closed_flag]
and rec_flag =  [%import: All_ast.Ast_5_5.Asttypes.rec_flag]
and direction_flag =  [%import: All_ast.Ast_5_5.Asttypes.direction_flag]
and private_flag =  [%import: All_ast.Ast_5_5.Asttypes.private_flag]
and mutable_flag =  [%import: All_ast.Ast_5_5.Asttypes.mutable_flag]
and virtual_flag =  [%import: All_ast.Ast_5_5.Asttypes.virtual_flag]
and override_flag =  [%import: All_ast.Ast_5_5.Asttypes.override_flag]
and variance =  [%import: All_ast.Ast_5_5.Asttypes.variance]
and injectivity =  [%import: All_ast.Ast_5_5.Asttypes.injectivity]

and constant =  [%import: All_ast.Ast_5_5.Parsetree.constant
    [@with Location.t := location_t]
]
and constant_desc =  [%import: All_ast.Ast_5_5.Parsetree.constant_desc
    [@with Location.t := location_t]
]
and location_stack = [%import: All_ast.Ast_5_5.Parsetree.location_stack
    [@with Location.t := location_t]
]
and attribute = [%import: All_ast.Ast_5_5.Parsetree.attribute
    [@with Asttypes.loc := location_loc
         ; Location.t := location_t
    ]
]
and extension = [%import: All_ast.Ast_5_5.Parsetree.extension
    [@with Asttypes.loc := location_loc]
]
and attributes = [%import: All_ast.Ast_5_5.Parsetree.attributes]
and payload = [%import: All_ast.Ast_5_5.Parsetree.payload]
and core_type = [%import: All_ast.Ast_5_5.Parsetree.core_type
    [@with Location.t := location_t]
]
and core_type_desc = [%import: All_ast.Ast_5_5.Parsetree.core_type_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.closed_flag := closed_flag
         ; Asttypes.arg_label := arg_label
...
and package_type = [%import: All_ast.Ast_5_5.Parsetree.package_type
    [@with Longident.t := longident_t
          ; Asttypes.loc := location_loc
          ; Location.t := location_t
    ]
]
and row_field = [%import: All_ast.Ast_5_5.Parsetree.row_field
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ; Location.t := location_t
...
and row_field_desc = [%import: All_ast.Ast_5_5.Parsetree.row_field_desc
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ]
]
and object_field = [%import: All_ast.Ast_5_5.Parsetree.object_field
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ; Location.t := location_t
...
and object_field_desc = [%import: All_ast.Ast_5_5.Parsetree.object_field_desc
    [@with
      Asttypes.label := label
    ; Asttypes.loc := location_loc
    ]
]
and pattern = [%import: All_ast.Ast_5_5.Parsetree.pattern
    [@with Location.t := location_t]
]
and pattern_desc = [%import: All_ast.Ast_5_5.Parsetree.pattern_desc
    [@with Longident.t := longident_t ;
      Asttypes.loc := location_loc ;
      Asttypes.label := label ;
      Asttypes.closed_flag := closed_flag
...
and expression = [%import: All_ast.Ast_5_5.Parsetree.expression
    [@with Location.t := location_t]
]
and expression_desc = [%import: All_ast.Ast_5_5.Parsetree.expression_desc
    [@with Longident.t := longident_t ;
      Asttypes.loc := location_loc ;
      Asttypes.label := label ;
      Asttypes.arg_label := arg_label ;
...
and case = [%import: All_ast.Ast_5_5.Parsetree.case]
and letop = [%import: All_ast.Ast_5_5.Parsetree.letop]
and binding_op = [%import: All_ast.Ast_5_5.Parsetree.binding_op
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and function_param_desc = [%import: All_ast.Ast_5_5.Parsetree.function_param_desc [@with Asttypes.loc := location_loc ; Asttypes.label := label ; Asttypes.arg_label := arg_label ; Asttypes.closed_flag := closed_flag ; Asttypes.rec_flag := rec_flag ; Asttypes.direction_flag := direction_flag ; Asttypes.private_flag := private_flag ; Asttypes.mutable_flag := mutable_flag ; Asttypes.virtual_flag := virtual_flag ; Asttypes.variance := variance ; Asttypes.override_flag := override_flag ; Asttypes.variance := variance ; Asttypes.injectivity := injectivity]]
and function_param = [%import: All_ast.Ast_5_5.Parsetree.function_param
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and function_body = [%import: All_ast.Ast_5_5.Parsetree.function_body
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_constraint = [%import: All_ast.Ast_5_5.Parsetree.type_constraint]
and value_description = [%import: All_ast.Ast_5_5.Parsetree.value_description
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_declaration = [%import: All_ast.Ast_5_5.Parsetree.type_declaration
    [@with Location.t := location_t
          ; Asttypes.loc := location_loc
          ; Asttypes.variance := variance
          ; Asttypes.injectivity := injectivity
...
and type_kind = [%import: All_ast.Ast_5_5.Parsetree.type_kind]
and label_declaration = [%import: All_ast.Ast_5_5.Parsetree.label_declaration
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.mutable_flag := mutable_flag
    ]
]
and constructor_declaration = [%import: All_ast.Ast_5_5.Parsetree.constructor_declaration
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and constructor_arguments = [%import: All_ast.Ast_5_5.Parsetree.constructor_arguments]
and type_extension = [%import: All_ast.Ast_5_5.Parsetree.type_extension
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.variance := variance
         ; Asttypes.injectivity := injectivity
...
and extension_constructor = [%import: All_ast.Ast_5_5.Parsetree.extension_constructor
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and type_exception = [%import: All_ast.Ast_5_5.Parsetree.type_exception
    [@with Location.t := location_t ;]
]
and extension_constructor_kind = [%import: All_ast.Ast_5_5.Parsetree.extension_constructor_kind
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and class_type = [%import: All_ast.Ast_5_5.Parsetree.class_type
    [@with Location.t := location_t]
]
and class_type_desc = [%import: All_ast.Ast_5_5.Parsetree.class_type_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.label := label
         ; Asttypes.arg_label := arg_label
...
and class_signature = [%import: All_ast.Ast_5_5.Parsetree.class_signature]
and class_type_field = [%import: All_ast.Ast_5_5.Parsetree.class_type_field
    [@with Location.t := location_t]
]
and class_type_field_desc = [%import: All_ast.Ast_5_5.Parsetree.class_type_field_desc
    [@with
      Asttypes.private_flag := private_flag
    ; Asttypes.mutable_flag := mutable_flag
    ; Asttypes.virtual_flag := virtual_flag
...
and 'a class_infos = [%import: 'a All_ast.Ast_5_5.Parsetree.class_infos
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.variance := variance
         ; Asttypes.injectivity := injectivity
...
and class_description = [%import: All_ast.Ast_5_5.Parsetree.class_description]
and class_type_declaration = [%import: All_ast.Ast_5_5.Parsetree.class_type_declaration]
and class_expr = [%import: All_ast.Ast_5_5.Parsetree.class_expr
    [@with Location.t := location_t]
]
and class_expr_desc = [%import: All_ast.Ast_5_5.Parsetree.class_expr_desc
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
         ; Asttypes.rec_flag := rec_flag
         ; Asttypes.label := label
...
and class_structure = [%import: All_ast.Ast_5_5.Parsetree.class_structure]
and class_field = [%import: All_ast.Ast_5_5.Parsetree.class_field
    [@with Location.t := location_t]
]
and class_field_desc = [%import: All_ast.Ast_5_5.Parsetree.class_field_desc
    [@with Asttypes.loc := location_loc
         ; Asttypes.override_flag := override_flag
         ; Asttypes.mutable_flag := mutable_flag
         ; Asttypes.private_flag := private_flag
...
and class_field_kind = [%import: All_ast.Ast_5_5.Parsetree.class_field_kind
    [@with Asttypes.override_flag := override_flag
    ]
]
and class_declaration = [%import: All_ast.Ast_5_5.Parsetree.class_declaration]
and module_type = [%import: All_ast.Ast_5_5.Parsetree.module_type
    [@with Location.t := location_t]
]
and module_type_desc = [%import: All_ast.Ast_5_5.Parsetree.module_type_desc
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and functor_parameter = [%import: All_ast.Ast_5_5.Parsetree.functor_parameter
    [@with Asttypes.loc := location_loc]
]
and signature = [%import: All_ast.Ast_5_5.Parsetree.signature]
and signature_item = [%import: All_ast.Ast_5_5.Parsetree.signature_item
    [@with Location.t := location_t]
]
and signature_item_desc = [%import: All_ast.Ast_5_5.Parsetree.signature_item_desc
    [@with Asttypes.rec_flag := rec_flag]
]
and module_declaration = [%import: All_ast.Ast_5_5.Parsetree.module_declaration
    [@with Location.t := location_t ;
           Asttypes.loc := location_loc
    ]
]
and module_substitution = [%import: All_ast.Ast_5_5.Parsetree.module_substitution
    [@with Longident.t := longident_t
         ; Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and module_type_declaration = [%import: All_ast.Ast_5_5.Parsetree.module_type_declaration
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and 'a open_infos = [%import: 'a All_ast.Ast_5_5.Parsetree.open_infos
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
         ; Asttypes.override_flag := override_flag
    ]
]
and open_description = [%import: All_ast.Ast_5_5.Parsetree.open_description
    [@with Longident.t := longident_t
          ; Asttypes.loc := location_loc
    ]
]
and open_declaration = [%import: All_ast.Ast_5_5.Parsetree.open_declaration]
and 'a include_infos = [%import: 'a All_ast.Ast_5_5.Parsetree.include_infos
    [@with Location.t := location_t]
]
and include_description = [%import: All_ast.Ast_5_5.Parsetree.include_description]
and include_declaration = [%import: All_ast.Ast_5_5.Parsetree.include_declaration]
and with_constraint = [%import: All_ast.Ast_5_5.Parsetree.with_constraint
    [@with Longident.t := longident_t
         ; Asttypes.loc := location_loc
    ]
]
and module_expr = [%import: All_ast.Ast_5_5.Parsetree.module_expr
    [@with Location.t := location_t]
]
and module_expr_desc = [%import: All_ast.Ast_5_5.Parsetree.module_expr_desc
    [@with Longident.t := longident_t ;
           Asttypes.loc := location_loc
    ]
]
and structure = [%import: All_ast.Ast_5_5.Parsetree.structure]
and structure_item = [%import: All_ast.Ast_5_5.Parsetree.structure_item
    [@with Location.t := location_t]
]
and structure_item_desc = [%import: All_ast.Ast_5_5.Parsetree.structure_item_desc
    [@with Location.t := location_t
          ; Longident.t := longident_t
          ; Asttypes.loc := location_loc
          ; Asttypes.rec_flag := rec_flag
...
and value_binding = [%import: All_ast.Ast_5_5.Parsetree.value_binding
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and value_constraint = [%import: All_ast.Ast_5_5.Parsetree.value_constraint
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and module_binding = [%import: All_ast.Ast_5_5.Parsetree.module_binding
    [@with Location.t := location_t
         ; Asttypes.loc := location_loc
    ]
]
and type_immediacy_t = [%import: All_ast.Ast_5_5.Type_immediacy.t]
and out_name = [%import: All_ast.Ast_5_5.Outcometree.out_name]
and out_ident = [%import: All_ast.Ast_5_5.Outcometree.out_ident]
and out_string = [%import: All_ast.Ast_5_5.Outcometree.out_string]
and out_attribute = [%import: All_ast.Ast_5_5.Outcometree.out_attribute]
and out_value = [%import: All_ast.Ast_5_5.Outcometree.out_value
    [@with All_ast.Ast_5_5.Format_doc.formatter := Format_doc.formatter
         ; Asttypes.mutable_flag := mutable_flag
    ]
]
and out_type = [%import: All_ast.Ast_5_5.Outcometree.out_type
    [@with Asttypes.arg_label := arg_label]
]
and out_variant = [%import: All_ast.Ast_5_5.Outcometree.out_variant]
and out_class_type = [%import: All_ast.Ast_5_5.Outcometree.out_class_type
    [@with Asttypes.arg_label := arg_label]
]
and out_class_sig_item = [%import: All_ast.Ast_5_5.Outcometree.out_class_sig_item]
and out_module_type = [%import: All_ast.Ast_5_5.Outcometree.out_module_type]
and out_sig_item = [%import: All_ast.Ast_5_5.Outcometree.out_sig_item]
and out_type_param = [%import: All_ast.Ast_5_5.Outcometree.out_type_param
    [@with
       Asttypes.variance := variance
     ; Asttypes.injectivity := injectivity
    ]
]
and out_row = [%import: All_ast.Ast_5_5.Outcometree.out_row]
and out_type_decl = [%import: All_ast.Ast_5_5.Outcometree.out_type_decl
    [@with Asttypes.private_flag := private_flag
        ; Type_immediacy.t := type_immediacy_t
    ]
]
and out_extension_constructor = [%import: All_ast.Ast_5_5.Outcometree.out_extension_constructor
    [@with Asttypes.private_flag := private_flag]
]
and out_constructor = [%import: All_ast.Ast_5_5.Outcometree.out_constructor]
and out_type_extension = [%import: All_ast.Ast_5_5.Outcometree.out_type_extension
    [@with Asttypes.private_flag := private_flag]
]
and out_val_decl = [%import: All_ast.Ast_5_5.Outcometree.out_val_decl]
and out_rec_status = [%import: All_ast.Ast_5_5.Outcometree.out_rec_status]
and out_ext_status = [%import: All_ast.Ast_5_5.Outcometree.out_ext_status]
and out_phrase = [%import: All_ast.Ast_5_5.Outcometree.out_phrase]
and out_package = [%import: All_ast.Ast_5_5.Outcometree.out_package]
and out_label = [%import: All_ast.Ast_5_5.Outcometree.out_label
    [@with Asttypes.mutable_flag := mutable_flag
         ; Asttypes.atomic_flag := atomic_flag
    ]
]
