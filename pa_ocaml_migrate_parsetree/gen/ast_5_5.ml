...
module Asttypes =
  struct
    ...
    type variance = Covariant | Contravariant | NoVariance | Bivariant
...
module Outcometree =
  struct
    ...
    type out_type =
      ...
      | Otyp_functor of
          Asttypes.arg_label * out_ident * out_package * out_type
    and out_row =
        Orow_closed
      | Orow_open_anonymous
    ...
    and out_package =
      { opack_path : out_ident; opack_constraints : (string * out_type) list }
    and out_variant =
